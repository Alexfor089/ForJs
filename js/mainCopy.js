...
AppData.prototype.addExpensesBlock = function () {
   ...
   // _this.addListenersStr(cloneExpensesItem.querySelectorAll("input")[0]);
   // cloneExpensesItem.querySelectorAll("input")[1].value = "";
   // _this.addListenersNum(cloneExpensesItem.querySelectorAll("input")[1]);
...
AppData.prototype.addIncomeBlock = function () {
   ...
   // _this.addListenersStr(cloneIncomeItem.querySelectorAll("input")[0]);
   // cloneIncomeItem.querySelectorAll("input")[1].value = "";
   // _this.addListenersNum(cloneIncomeItem.querySelectorAll("input")[1]);
